// 添加全局站点信息  
var BASE_URL = 'F:/Code/文件上传/webuploader-0.1.5';
jQuery(function () {
    ...
    uploader = WebUploader.create({
        ...
        chunked: true,
        server: '/FileUpload/UploadPhoto',
        deleteServer: '/FileUpload/DelPhoto',
        fileNumLimit: 10,
    ...
    uploader.on('uploadSuccess', function (file, data) {
        ...
        if (data.status == 0) {
            ...
            $btns.on('click', 'span', function () {
                ...
                switch (index) {
                    case 0:
                        $.post("/FileUpload/DeletePhoto", { "photoName": data.filePath }, function (rlt) {
                            if (rlt) {
                                uploader.removeFile(file);
                            } else {
                                console.log("删除失败");
